...
from plugin.data.data_utils import default_loader
...
class TextRecognitionDataset(FairseqDataset):
    ...
    def __init__(
            self, src, tgt, tgt_simply, tgt_dict, tgt_sizes=None,
    ...
    def __getitem__(self, index):
        ...
        tgt_simply_item = self.tgt_simply[index]
        tgt_length = self.tgt_sizes[index]
        # Convert label to a numeric ID.
        tgt_item = torch.IntTensor([self.tgt_dict.index(i) for i in tgt_item])
        tgt_simply_item = torch.IntTensor([self.tgt_dict.index(i) for i in tgt_simply_item])
